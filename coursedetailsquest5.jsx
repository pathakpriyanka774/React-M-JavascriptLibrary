...
class StudyCourse1 extends Component{
   state={
    mydtail1:{
        name:"",
        designation:"",
        ...
        <div className="container w-50 border">
            <h1>Provide Details below</h1>
                            {arr.map(t1=>(
                                ...
                                <input className="form-check-input" type="radio" value={t1} name="mysts" checked={myarr.findIndex((n1)=>n1===t1) >=0}
