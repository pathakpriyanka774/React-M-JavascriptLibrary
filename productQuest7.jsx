...
import ProductPannel7 from "./productPannelquest7";
class ProductQuest7 extends Component{
    state={
...
showProd = () =>{
        ...
        const pd1=pName.length >0 ? products.filter((lt)=>lt.category===pName):[];
        return (
            <div className="container">
                <h4>Selected Products:{pName}</h4>
                {
                    pd1.map((lt)=>(
                        <div className="row">
    ...
    render(){
        const {catarr,products,optionsSel}=this.state;
